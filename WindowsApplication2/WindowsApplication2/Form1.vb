...
Public Class Form1
    ...
    ' Prepara la ventana de login, aplica el diseno y la centra en pantalla.
    ...
    ' Crea el bloque visual de acceso, aplica estilos y fija el tamano del login.
    ...
    ' Calcula la posicion para mostrar el login al centro del area util.
    ...
    ' Crea el panel informativo lateral usado por el diseno de acceso.
    ...
    ' Aplica colores, fuentes, textos, logo y botones de la pantalla de acceso.
    ...
    ' Acomoda logo, credenciales y botones dentro de la ventana fija del login.
    ...
    ' Reacomoda el login cuando la ventana cambia de tamano.
    ...
    ' Cierra la ventana de acceso cuando el usuario cancela.
